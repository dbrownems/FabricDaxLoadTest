...
{
    // QueryRunnerLogger lives in QueryRunnerLogger.cs.
    // QueryResult        lives in QueryResult.cs.
    // QueryRunnerStatus  (and nested WindowSnapshot) lives in QueryRunnerStatus.cs.
    // TelemetryRecord remains here because it is internal and only used
    // by the executions-CSV writer in this file.
